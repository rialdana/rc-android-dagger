...
class EnterDetailsFragment : Fragment() {
    ...
    // Removed private visibility modifier and added inject annotation
    @Inject
    ...
    // Fragments should always be injected using onAttach
    override fun onAttach(context: Context) {
        super.onAttach(context)

        // injecting the fragment to the subcomponent that lives in the activity
